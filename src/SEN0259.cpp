...
* Parameters:   seriallib address - object used to read data from serial port
                string port - the port in which the device is connected
* Side Effects: Prints error if device fails to open or if an exception occurs
* Error Conditions: None
* Return Value: None
*/
void SEN0259::begin(serialib &device, string port)
{
    TFSerial = &device;
    char openStatus;
